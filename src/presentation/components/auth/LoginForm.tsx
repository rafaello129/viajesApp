...
import { FiArrowRight, FiLock, FiUser, FiMapPin, FiShield, FiChevronDown } from 'react-icons/fi';
      ...
      <div className="lg:hidden relative bg-gradient-to-br from-[#0A0A0A] via-[#1E3A5F] to-[#0A0A0A] p-6 pb-8">
        ...
        <div className="relative z-10 text-center mb-6">
          <h2 className="text-2xl font-['Playfair_Display'] font-bold text-white leading-tight mb-2">
            Where Security
            <br />
            <span className="text-[#D4AF37]">Meets the Sky</span>
          </h2>
          <p className="text-sm text-[#E0E0E0]/80 font-['Inter'] max-w-sm mx-auto">
            Tu ecosistema de viajes de lujo con seguridad absoluta
          </p>
        </div>
        ...
        <div className="relative z-10">
          ...
          >
            <span>{showMobileInfo ? 'Ocultar características' : 'Ver características'}</span>
            <FiChevronDown 
            ...
            <div className="grid grid-cols-1 gap-3">
              <div className="flex items-start gap-3 bg-[#1A1A1A]/50 backdrop-blur-sm p-3 rounded-lg border border-[#2A2A2A]">
                ...
                <div>
                  ...
                  <p className="text-[#E0E0E0]/70 text-xs font-['Inter']">
                    Mapas inteligentes con alertas y zonas verificadas
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 bg-[#1A1A1A]/50 backdrop-blur-sm p-3 rounded-lg border border-[#2A2A2A]">
                ...
                <div>
                  ...
                  <p className="text-[#E0E0E0]/70 text-xs font-['Inter']">
                    Asistente personal inteligente para cada momento
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 bg-[#1A1A1A]/50 backdrop-blur-sm p-3 rounded-lg border border-[#2A2A2A]">
                ...
                <div>
                  ...
                  <p className="text-[#E0E0E0]/70 text-xs font-['Inter']">
                    Acceso a eventos, villas y destinos únicos
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="relative z-10 space-y-8 max-w-xl">
          <div className="space-y-4">
            ...
            <p className="text-lg text-[#E0E0E0] leading-relaxed font-['Inter']">
              Tu ecosistema de viajes de lujo. Planifica, conecta y explora con seguridad absoluta en cada destino de Latinoamérica.
            </p>
          </div>
      ...
      <div className="lg:w-1/2 bg-[#0A0A0A] flex items-center justify-center p-6 lg:p-16 flex-1">
        <div className="w-full max-w-md space-y-6 lg:space-y-8 animate-fade-in">
          ...
          <div className="space-y-3">
            <div className="inline-block px-3 py-1 rounded-full bg-[#D4AF37]/10 border border-[#D4AF37]/20 mb-2 lg:mb-4">
            ...
            <p className="text-sm lg:text-base text-[#E0E0E0]/70 font-['Inter']">
              Accede a tu mundo de experiencias exclusivas
            </p>
          </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  required
                  className="relative w-full pl-12 pr-4 py-3.5 lg:py-4 bg-[#1A1A1A]/80 border border-[#2A2A2A] rounded-xl text-white placeholder:text-[#E0E0E0]/20 focus:outline-none focus:ring-2 focus:ring-[#D4AF37]/50 focus:border-[#D4AF37]/50 transition-all duration-300 font-['Inter'] backdrop-blur-sm hover:border-[#2A2A2A]/80 text-base"
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <a 
                  ...
                  className="text-xs text-[#1E3A5F] hover:text-[#D4AF37] transition-colors duration-300 font-['Inter'] font-medium"
                >
          ...
          <div className="grid grid-cols-2 gap-3 lg:gap-4">
            <button
              type="button"
              className="relative py-3 lg:py-3.5 px-3 lg:px-4 rounded-xl border border-[#2A2A2A] bg-[#1A1A1A]/50 hover:bg-[#1A1A1A] hover:border-[#D4AF37]/30 transition-all duration-300 flex items-center justify-center gap-2 lg:gap-3 text-sm font-medium text-[#E0E0E0] font-['Inter'] backdrop-blur-sm group overflow-hidden"
            >
          ...
          {/* Footer */}
          <div className="text-center text-sm text-[#E0E0E0]/60 font-['Inter'] pt-2 lg:pt-4">
            ¿Nuevo en ALAYA?{" "}
            <a href="register" className="text-[#D4AF37] font-semibold hover:text-[#E5C158] transition-colors duration-300 inline-flex items-center gap-1 group">
              Crea tu cuenta
          ...
          {/* Trust indicators */}
          <div className="flex items-center justify-center gap-4 lg:gap-6 pt-4 lg:pt-6 border-t border-[#2A2A2A]">
            ...
            <div className="flex items-center gap-2 text-[#E0E0E0]/40 text-xs font-['Inter']">
              ...
              <span className="hidden sm:inline">Datos Encriptados</span>
              <span className="sm:hidden">Encriptado</span>
            </div>
          </div>
